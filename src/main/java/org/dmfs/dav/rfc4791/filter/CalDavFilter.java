...
/**
 * The base class of all filters in the CalDAV namespace.
 */
public abstract class CalDavFilter extends FilterBase
{
    ...
    /**
     * A special filter that matches when a structured element (i.e. a {@link CompFilter} or a {@link PropFilter}) is not present. This is for internal use.
     */
