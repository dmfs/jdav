...
public class Response implements Recyclable
{
	...
	/**
	 * An {@link IXmlObjectBuilder} for {@link Response} elements.
	 */
	public final static IObjectBuilder<Response> BUILDER = new AbstractObjectBuilder<Response>()
	{
		...
		@Override
		public <V> Response update(ElementDescriptor<Response> descriptor, Response object, ElementDescriptor<V> childDescriptor, V child, ParserContext context)
	...
	private List<URI> mHrefs = new ArrayList<URI>(16);
	...
	/**
	 * All {@link PropStat} children by {@link XmlElementDescriptor}.
	 */
