...
public final class TextMatch extends CalDavFilter
{
	 ...
	 */
	public final static String COLLATION_I_ASCII_CASEMAP = "i;ascii-casemap";
	...
	/**
	 * Creates a non-negated, case-insensitive text-match filter, using the default collation {@link #COLLATION_I_ASCII_CASEMAP}.
	 * 
	 * @param value
	 *            The filter value.
	 */
	...
	/**
	 * Create a case-insensitive text-match filter, using the default collation {@link #COLLATION_I_ASCII_CASEMAP}.
	 * 
	 * @param value
	 *            The filter value.
	 * @param negate
	 ...
	 *            Perform case-insensitive matching using the default collation {@link #COLLATION_I_ASCII_CASEMAP}.
	 */
	public TextMatch(String value, boolean negate, boolean caseInsensitive)
	{
		this(value, negate, caseInsensitive ? COLLATION_I_ASCII_CASEMAP : null);
	}
	 ...
	 */
	public TextMatch(String value, boolean negate, String collation)
	{
		this.value = value;
		this.negate = negate;
