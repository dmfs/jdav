...
public class CalDav
{
	 ...
	 */
	public final static QualifiedName QN_CALENDAR = QualifiedName.get(NAMESPACE, "calendar");

	/**
	 * calendar element as defined in <a href="http://tools.ietf.org/html/rfc4791#section-9.1">RFC 4791, section 9.1</a>.
	 */
	public final static ElementDescriptor<QualifiedName> RESOURCE_CALENDAR = ElementDescriptor.register(QN_CALENDAR, QualifiedNameObjectBuilder.INSTANCE);
	...
	private final static QualifiedName QN_CALENDAR_QUERY = QualifiedName.get(NAMESPACE, "calendar-query");

	/**
	 * Definition of calendar-query in the default (response) context.
	 */
	public final static ElementDescriptor<QualifiedName> CALENDAR_QUERY = ElementDescriptor.register(QN_CALENDAR_QUERY, QualifiedNameObjectBuilder.INSTANCE);
	 ...
	 * </p>
	 */
	public final static ElementDescriptor<CalendarQuery> CALENDAR_QUERY_REPORT = ElementDescriptor.register(QN_CALENDAR_QUERY, CalendarQuery.BUILDER,
		WebDav.REQUEST_CONTEXT);

	/**
	 * {@link QualifiedName} of the calendar-multiget element.
	 */
	private final static QualifiedName QN_CALENDAR_MULTIGET = QualifiedName.get(NAMESPACE, "calendar-multiget");

	/**
	 * Definition of calendar-multiget in the default (response) context.
	 */
	public final static ElementDescriptor<QualifiedName> CALENDAR_MULTIGET = ElementDescriptor.register(QN_CALENDAR_MULTIGET,
	 ...
	 * </p>
	 */
	public final static ElementDescriptor<CalendarMultiget> CALENDAR_MULTIGET_REPORT = ElementDescriptor.register(QN_CALENDAR_MULTIGET,
	...
	public final static ElementDescriptor<String> PROP_CALENDAR_DESCRIPTION = ElementDescriptor.register(QualifiedName.get(NAMESPACE, "calendar-description"),
		StringObjectBuilder.INSTANCE);

	public final static ElementDescriptor<String> PROP_CALENDAR_TIMEZONE = ElementDescriptor.register(QualifiedName.get(NAMESPACE, "calendar-timezone"),
		StringObjectBuilder.INSTANCE);

	public final static ElementDescriptor<Set<String>> PROP_SUPPORTED_CALENDAR_COMPONENT_SET = ElementDescriptor.register(
	...
	/**
	 * calendar-home-set is defined in <a href="http://tools.ietf.org/html/rfc4791#section-6.2.1">RFC 4791, section 6.2.1</a>. It's a principal property and may
	 * not be defined on other resources.
	 * <p>
	 ...
	 * </pre>
	 */
	public final static ElementDescriptor<Set<URI>> PROP_CALENDAR_HOME_SET = ElementDescriptor.register(QualifiedName.get(NAMESPACE, "calendar-home-set"),
